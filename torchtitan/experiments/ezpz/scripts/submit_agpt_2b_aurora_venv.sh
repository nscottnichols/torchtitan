#!/bin/bash --login
#PBS -A AuroraGPT
#PBS -N agpt-2b-sophiag-olmo-mix-n256-v2
...
# Aurora-adapted variant of train_agpt_2b_venv.sh.
...
# Kill stale palsd processes from previous runs (mirroring the torch 2.10 script).
