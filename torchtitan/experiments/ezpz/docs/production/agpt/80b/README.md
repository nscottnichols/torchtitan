...
|--------|------|-------|---------------------|---------|-----|--------|--------|
| [`8444124`](#log-8444124) | 2026-04-22 | 0 | — | — | — | — | Segfault (node) |
| [`8446345`](#log-8446345) | 2026-04-25 | 1–685+ | 12.94 → NaN (step 138) | 92 | 16.8% | 52.94 GiB | **Running** (NaN) |
| [`8446346`](#log-8446346) | 2026-04-25 | cont. | — | — | — | — | Held (dep) |
...
| Job ID | Date | Steps | Loss (start → end) | TPS/GPU | MFU | Memory | Status |
|--------|------|-------|---------------------|---------|-----|--------|--------|
| [`8443820`](#log-8443820) | 2026-04-22 | 0 | — | — | — | — | CPU OOM (compile) |
| [`8446347`](#log-8446347) | 2026-04-25 | — | — | — | — | — | Queued |
| [`8446348`](#log-8446348) | 2026-04-25 | 1–495+ | 12.94 → NaN (step 15) | 65 | 11.9% | 56.33 GiB | **Running** (NaN) |
...
| Job ID | Date | Steps | Loss (start → end) | TPS/GPU | MFU | Memory | Status |
|--------|------|-------|---------------------|---------|-----|--------|--------|
| [`8451225`](#log-8451225) | 2026-04-26 | 1–51 | 12.94 → 12.91 | — | — | — | Complete (walltime) |
| [`8451226`](#log-8451226) | 2026-04-26 | 0 | — | — | — | — | Crashed (Gloo timeout, bad node) |
