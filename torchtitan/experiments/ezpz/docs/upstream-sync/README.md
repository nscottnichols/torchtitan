...
python3 -m torchtitan.experiments.ezpz.eval.loss_baseline check \
    ...
    --baseline torchtitan/experiments/ezpz/docs/upstream-sync/baselines/agpt_2b_50.json

python3 -m torchtitan.experiments.ezpz.eval.loss_baseline check \
    --log smoke_moe_vNN.o<jobid> \
    --baseline torchtitan/experiments/ezpz/docs/upstream-sync/baselines/moe_500m_50.json
