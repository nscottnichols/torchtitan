...
| 2026-06-10 | [SFT 2B + tulu_math_uc_mix, autoretry failover (n32)](sunspot/20260610-sft-2b-tulu-mix-n32-failover.md) | AuroraGPT-2B-sophiag-138650 + `tulu-3-sft-mixture:0.65 + metamathqa:0.15 + ultrachat-200k:0.20`, GBS=6144, FSDP1 | 32 (+ 4 spare) | End-to-end validation of `ezpz launch --auto-retry` over 4 PBS jobs surviving 3 oneCCL SIGABRTs. Loss 1.16→0.79 through epoch 2.0 (~2.5B tokens). Cleared two upstream blockers inline: [pytorch/pytorch#186938](https://github.com/pytorch/pytorch/issues/186938) (XPU FSDP resume) + [`6b4a00b`](https://github.com/saforem2/ezpz/commit/6b4a00b) (autoretry STUCK_PRE_TRAINING false-positive on TRL log format). |
