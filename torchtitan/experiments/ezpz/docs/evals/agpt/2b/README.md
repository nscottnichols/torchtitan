...
**Backfill in flight (2026-06-10):** 7-task results landed for ckpts
step-36,000 onward (2B 256N) and all v2 512N ckpts. The early 2B 256N
range (step-200 → step-25,100) is being re-evaluated by job `8533774`
(Q for capacity slot); shown as `_pending_` below until those land.

| Run | Step | Tokens (B) | HellaSwag | ARC-Easy | ARC-Chall | Winogrande | PIQA | OpenBookQA | BoolQ |
|-----|-----:|-----------:|----------:|---------:|----------:|-----------:|-----:|-----------:|------:|
| **v2 256N** | **200** | **10.1** | **0.2548** | **0.2618** | **0.2270** | **0.4933** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **400** | **20.1** | **0.2542** | **0.2875** | **0.2167** | **0.4925** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **600** | **30.2** | **0.2601** | **0.3161** | **0.2278** | **0.4862** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **800** | **40.3** | **0.2621** | **0.3401** | **0.2065** | **0.4799** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **1,000** | **50.3** | **0.2616** | **0.3826** | **0.2125** | **0.4996** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **1,200** | **60.4** | **0.2682** | **0.4112** | **0.2142** | **0.5146** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **1,400** | **70.5** | **0.2748** | **0.4276** | **0.2201** | **0.5067** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **1,600** | **80.5** | **0.2839** | **0.4364** | **0.2270** | **0.5059** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **1,800** | **90.6** | **0.2942** | **0.4356** | **0.2338** | **0.5020** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **2,000** | **100.7** | **0.3014** | **0.4819** | **0.2346** | **0.4957** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **14,000** | **704.6** | **0.4878** | **0.5981** | **0.3038** | **0.5185** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **15,000** | **755.0** | **0.4929** | **0.6048** | **0.2995** | **0.5193** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **16,000** | **805.3** | **0.5020** | **0.6077** | **0.2918** | **0.5304** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **17,000** | **855.6** | **0.5064** | **0.6090** | **0.2995** | **0.5272** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **18,000** | **906.0** | **0.5045** | **0.6107** | **0.2961** | **0.5335** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **19,000** | **956.3** | **0.5046** | **0.6065** | **0.3055** | **0.5414** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **20,000** | **1006.6** | **0.5109** | **0.6174** | **0.2995** | **0.5383** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **21,000** | **1057.0** | **0.5203** | **0.6204** | **0.2927** | **0.5328** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **22,000** | **1107.3** | **0.5181** | **0.6166** | **0.3012** | **0.5383** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **23,000** | **1157.6** | **0.5232** | **0.6216** | **0.3020** | **0.5320** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **24,000** | **1208.0** | **0.5236** | **0.6242** | **0.3055** | **0.5501** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **25,000** | **1258.3** | **0.5225** | **0.6237** | **0.3080** | **0.5272** | _pending_ | _pending_ | _pending_ |
| **v2 256N** | **25,100** | **1263.3** | **0.5297** | **0.6279** | **0.3080** | **0.5320** | _pending_ | _pending_ | _pending_ |
