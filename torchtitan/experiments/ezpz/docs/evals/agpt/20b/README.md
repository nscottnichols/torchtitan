...
**Backfill status (2026-06-10):** 30/36 ckpts re-evaluated with the
7-task set. 6 ckpts still pending (`backfill pending` rows below)
— steps 2,200 / 2,400 / 4,000 / 4,100 / 4,200 / 4,300, being filled
in by resume jobs `8534628` (R) and `8534655` (R). Expected to
complete in ~2-3h.
...
| _v2 512N sync_ | _4,000_ | _402.7_ | _backfill pending_ | | | | | | |
| _v2 512N sync_ | _4,100_ | _412.7_ | _backfill pending_ | | | | | | |
| _v2 512N sync_ | _4,200_ | _422.8_ | _backfill pending_ | | | | | | |
| _v2 512N sync_ | _4,300_ | _432.8_ | _backfill pending_ | | | | | | |
